    ...
    <div class="w-full">
        <div class="lg:w-2/3 w-full mx-auto mt-8 overflow-auto">
            <table class="table-auto w-full text-left whitespace-no-wrap">
                ...
                <tr>
                    ...
                    <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-200">Quantidade</th>
                    <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-200">Preço</th>
                    <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-200">Ações</th>
                </tr>
                </thead>
                <tbody>
                ...
                <tr>
                    <td class="p-4 font-bold">Valor Total</td>
        ...
        <div class="lg:w-2/3 w-full mx-auto mt-8">
            <div class="flex flex-wrap -mx-2 mt-8">
                <div class="p-2 w-1/3">
                    <div class="relative">
                        <label for="first_name" class="leading-7 text-sm text-gray-600">Primeiro Nome</label>
                        <input
                            type="text"
                            id="first_name"
                            name="first_name"
                ...
                <div class="p-2 w-1/3">
                    <div class="relative">
                        <label for="last_name" class="leading-7 text-sm text-gray-600">Último Nome</label>
                        <input
                            type="text"
                            id="last_name"
                            name="last_name"
            ...
            <div class="flex flex-wrap -mx-2 mt-4">
                <div class="p-2 w-1/3">
                    <div class="relative">
                        <label for="address" class="leading-7 text-sm text-gray-600">Rua</label>
                        <input
                            type="text"
                            id="address"
                            name="address"
                ...
                <div class="p-2 w-1/6">
                    <div class="relative">
                        <label for="zip_code" class="leading-7 text-sm text-gray-600">CEP</label>
                        <input
                            type="email"
                            id="zip_code"
                            name="zip_code"
            ...
            <div class="flex flex-wrap -mx-2 mt-4">
                <div class="p-2 w-full">
                    <div class="relative">
                        <label for="card-element" class="leading-7 text-sm text-gray-600">Informações do Cartão de Crédito</label>
            ...
            <div class="p-2 w-full">
                <button
                    ...
                    :disabled="paymentProcessing"
                    v-text="paymentProcessing ? 'Processando' : 'Pagar Agora'"
                ></button>
            </div>
        </div>
    </div>
